            ...
            <main>
                <form onSubmit={handleCreateClass}>
                    <fieldset>
                        ...
                        <Input name="name" label="Nome" value={name} required onChange={(event) => {setName(event.target.value)}} />
                        ...
                        {scheduleItems.map((scheduleItem, index) => {
                            return (
                                <div key={index} className="schedule-item">
                                    ...
                                    <Input name="from" label="Das" type="time" value={scheduleItem.from} onChange={event => setScheduleItemValue(index, 'from', event.target.value)} />
                                    <Input name="to" label="Até" type="time" value={scheduleItem.to} onChange={event => setScheduleItemValue(index, 'to', event.target.value)} />
                                </div>
                            )
                        })}
